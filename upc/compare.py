...
def main(file1, file2):
    ...
    plt.xlabel("Czas [s]")
    plt.ylabel("Wartość")
    print(f"Ploted: Oryginalny sygnał")
    plt.subplot(2, 2, 2)
    ...
    print(f"Ploted: Oryginalne Spektrum")
    plt.subplot(2, 2, 3)
    plt.plot(t2, reconstructed_signal)
    plt.title("Zrekonstruowany sygnał")
    plt.xlabel("Czas [s]")
    plt.ylabel("Wartość")
    print(f"Ploted: Zrekonstruowany sygnał")
    plt.subplot(2, 2, 4)
    ...
    plt.xlabel("Częstotliwość [Hz]")
    plt.ylabel("Amplituda")
    print(f"Ploted: Wyliczone Spektrum")
    plt.tight_layout()
    plt.savefig("plot.png")
    print(f"Zapisano do .png")
